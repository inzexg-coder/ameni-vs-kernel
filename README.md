...
Веб-интерфейс на светлом фоне с сиреневыми акцентами. Все метрики распределены по карточкам-нодам с FontAwesome иконками, фоновыми линиями и ассоциативными анимациями.
...
| **Uptime** | Время работы системы (иконка часов) |
| **Battery** | Процент заряда, статус (зарядка/разрядка, иконка молнии) |
| **Disk** | Список разделов с заполнением |
| **Network** | Интерфейсы с RX/TX (иконка сигнала) |
...
| Uptime | Боковая полоса, иконка часов |
| Battery | Иконка молнии при зарядке |
| Disk | Сканирующая линия |
| Network | Иконка сигнала с пульсацией |
...
Все числовые значения и бары окрашиваются по этой шкале.
